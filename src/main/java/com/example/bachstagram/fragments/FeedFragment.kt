...
import com.example.bachstagram.MainActivity
import com.example.bachstagram.Post
import com.example.bachstagram.PostAdapter
import com.example.bachstagram.R
...
open class FeedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // This is where we set up our views and click listener
        ...
        // 5. Set layout manger on RecyclerView
    ...
    open fun queryPosts() {
        ...
        // clear out what's in the adapter/currently fetched posts
        adapter.clear()
